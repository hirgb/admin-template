 ...
 * @LastEditTime: 2019-09-16 17:50:04
 -->
<template lang="html">
    <el-dialog id="add-activity-plan" title="新建活动计划" :close-on-click-modal="false" :visible.sync="dialogVisible" width="50%">
    <el-form ref="addActivityPlanForm" :inline="false" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
            <el-col :span="16">
                <el-form-item prop="doubanUrl" label="Url">
                    <el-input v-model="form.doubanUrl"></el-input>
                </el-form-item>

            </el-col>
            <!-- <el-col :span="8">
                <el-form-item label="豆瓣Dp">
                    <el-input v-model="form.doubanDp"></el-input>
                </el-form-item>
            </el-col> -->
        </el-row>
        <el-row>
...
export default {
    ...
    methods: {
        show() {
            ...
            window.setTimeout(()=>{
                this.$refs.addActivityPlanForm.clearValidate()
            }, 0)
        },
        reset() {
            // this.$refs.addActivityPlanForm.resetFields()
            this.form = {
                name: '',
                image: '',
                score: 0,
        ...
        submit() {
            this.$refs.addActivityPlanForm.validate((isSuccess)=>{
                if (isSuccess) {
                    this.loading = true
                    this.$axios.post(this.$config.dataServer + 'web/plan/addPlan',
                    this.$z.axios.urlEncode({ ...this.form,
                        cardType: this.type,
